...
ReplayPlayer::ReplayPlayer(const std::shared_ptr<Board> &board, const std::shared_ptr<Board> &enemy_board,
                           ...
                           const std::vector<std::string>::const_iterator &end_iterator, bool print_in_terminal, const std::string &file_name) : Player{board, enemy_board},
                                                                                           place_command_{board,
                                                                                                          enemy_board,
                                                                                                          logger},
                                                                                           moves_iterator_{
                                                                                                   moves_iterator},
                                                                                           end_iterator_{end_iterator}, print_in_terminal_{print_in_terminal}, file_name_{file_name} {
